...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      ///
      /// Locales: Base, ru, en
      static let error_accurated = Rswift.StringResource(key: "error_accurated", tableName: "Localizable", bundle: R.hostingBundle, locales: ["Base", "ru", "en"], comment: nil)
      ...
      ///
      /// Locales: Base, ru, en
      static func error_accurated(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("error_accurated", bundle: hostingBundle, value: "Error", comment: "")
        }

        guard let (_, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "error_accurated"
        }

        return NSLocalizedString("error_accurated", bundle: bundle, value: "Error", comment: "")
      }
